//
// tb_i8253_mode3 -- does counter 0 in mode 3 toggle forever?
//
// The boot bench watched the i8253's mode-3 output stop after a handful of
    ...
    always_ff @(posedge clk) begin
        ...
        if (out0 != out0_d) begin
            ...
            $display("%t  EDGE #%0d  out=%b  gap=%0t ns  count=%05X  mode=%0d rl=%b start=%b",
                     ...
                     u_pit.u_i8253_Counter_0.select_mode,
                     u_pit.u_i8253_Counter_0.select_read_write,
                     u_pit.u_i8253_Counter_0.start_counting);
        end
    end
