...
//
`include "i8259_Common_Package.svh"

module i8259_Priority_Resolver (
    ...
    import i8259_Common_Package::rotate_right;
    import i8259_Common_Package::rotate_left;
    import i8259_Common_Package::resolv_priority;
