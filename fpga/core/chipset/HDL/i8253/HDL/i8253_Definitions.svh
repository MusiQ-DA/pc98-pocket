...
`ifndef i8253_DEFINITIONS_SVH
`define i8253_DEFINITIONS_SVH
...
`define i8253_CONTROL_MODE_0   (3'b000)
`define i8253_CONTROL_MODE_1   (3'b001)
`define i8253_CONTROL_MODE_2   (3'b?10)
`define i8253_CONTROL_MODE_3   (3'b?11)
`define i8253_CONTROL_MODE_4   (3'b100)
`define i8253_CONTROL_MODE_5   (3'b101)
