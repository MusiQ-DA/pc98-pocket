...
// The VKB draws a PC-9801 keyboard and always emits Set-2. For the PC-98-only
// keys (STOP, KANA, GRPH, XFER, NFER, HELP, ROLL, INS, DEL, RO, keypad-/) the
// table substitutes bare Set-2 codes that no real keyboard sends -- see the
// assignment table in vkb_layout.c. The Set-2 -> PC-98 translator downstream
// must decode those codes the same way.
